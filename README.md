...
- **Options Greeks Calculator & Payoff Visualizer (Black–Scholes)**  
  European options pricing tool implementing the Black–Scholes model with full Greeks (Delta, Gamma, Vega, Theta, Rho), payoff diagrams, and sensitivity analysis across moneyness and volatility.  
  – Built to develop intuition around risk exposures and basic hedging concepts.  
  – Repo: `[https://github.com/samalsarthak21/black-scholes-greeks-and-payoffs]`
  
- **NIFTY 50 ARIMA+GARCH Forecasting Dashboard**  
  Forecasting pipeline on 10+ years of index data using ARIMA for returns and GARCH for volatility, including residual diagnostics and performance evaluation.  
  – Achieved lower test RMSE compared to a naive baseline forecast.  
